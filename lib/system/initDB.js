...
function initDB(m, client) {
  ...
  settings.nameid ??= "'ೃ࿔ ყµҡเ ωαɓσƭ - σƒƒเ૮เαℓ ૮ɦαɳɳεℓ .ೃ࿐'"
  settings.type ??= 'Owner'
  settings.link ??= 'https://api.stellarwa.xyz'
  settings.banner ??= 'https://raw.githubusercontent.com/AkiraDevX/uploads/main/uploads/1767704977299_946356.jpeg'
  settings.icon ??= 'https://cdn.yuki-wabot.my.id/files/6Z4w.jpeg'
  settings.currency ??= 'Yenes'
  settings.namebot ??= 'yumi'
  settings.botname ??= 'Yumi Suou'  
  settings.owner ??= ''
